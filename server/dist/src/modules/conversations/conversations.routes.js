...
import { createDMSchema, createGroupSchema, updateGroupSchema, addParticipantsSchema, } from './conversations.service.js';
const router = Router();
...
router.post('/:id/participants', validate(addParticipantsSchema), controller.addParticipants);
